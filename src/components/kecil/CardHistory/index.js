            ...
            >
                ...
                return (
                    <View key={index} style={styles.history}>
                        ...
                        <Image source={{uri: history[key].product.gambar[0]}} style={styles.produk}/>
    
                        <View style={styles.desc}>
                            <Text style={styles.nama}>
                                {history[key].product.nama}
                            </Text>
                ...
                <View style={styles.footer}>
                    ...
                    <View style={styles.label}>
                        ...
                        <Text style={styles.textPrimary}>Ongkir ({pesanan.estimasi} Hari) : </Text>
                        <Text style={styles.textPrimary}>Total Harga</Text>
                    </View>
    
                    <View style={styles.label}>
                        <Text style={styles.textPrimary}>{updateStatusLoading ? "Loading" : pesanan.status}</Text>
                        <Text style={styles.textPrimary}>Rp. {numberWithCommas(pesanan.ongkir)}</Text>
                        <Text style={styles.textPrimary}>Rp. {numberWithCommas(pesanan.totalHarga+pesanan.ongkir)}</Text>
                    </View>
